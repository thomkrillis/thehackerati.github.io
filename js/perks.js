  ...
  function checkWidth() {
    ...
    if(screen.width > 1024) {
	    ...
	    if (windowsize >= 1010) {
	    	...
	    	//console.log("window size is greater than or equal to threshold");
			...
			//console.log("window size is less than threshold");
	...
	} //end screen width here

	else if(screen.width <= 1024) {
		//console.log("screen size smaller than threshold");
